    ...
    static create() {
        ...
        <div class="max-w-2xl w-full mx-auto">
            ...
            <div class="relative inline-block text-left">
                <select id="conversion" class="w-full px-4 py-2 focus:outline-none">
            ...
            <div class="flex justify-center py-2"> 
                <button class="w-10/12 sm:w-1/4 text-center bg-blue-500  hover:bg-blue-600 active:bg-blue-700 focus:outline-none focus:ring focus:ring-blue-300 p-2 rounded-full text-white">変換</button>
            </div>
        </div>
            `;
    }
